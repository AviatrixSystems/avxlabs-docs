...
This is an established connection between an **Aviatrix Edge** device deployed in the remote data center in New York and a LAN router. This S2C connection was pre-deployed at the launch of the POD!s 
