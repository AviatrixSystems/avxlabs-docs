...
```{important}
You will notice that there are no **ECHO Reply** packets captured on the **_eth-fn0_** interface of the Transit FireNet Gateway, which should have been generated by the Mobile App EC2 itself.
