...
Unless otherwise mentioned, the lab PODs will be available until Wednesday afternoon US Pacific time the week of the training. In other words, <ins>the pods will be torn down on Wednesday afternoon</ins>.
...
By the end of **Day 2**, each student will be able to deploy and verify the following Multicloud Topology, including the following use cases:
...
In particular, resources in AWS us-east-1 will not be used until Lab 4. 
```