...
Now let’s add the office connection. In Copilot, navigate to **_Networking --> Connectivity --> External Connections (S2C)_**. Click the **`+ External Connection To`** button to add a new connection. Afterwards, select the `"External Device"` option from the drop-down window.

```{figure} images/lab-2-ext.png
---
height: 400px
align: center
---
