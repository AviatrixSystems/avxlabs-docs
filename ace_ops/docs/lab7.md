...
Enforce the policy in the data plane and click **Commit**. While East–West traffic will be blocked, you will still be able to intercept traffic generated by both databases due to the default WebGroup applied to the Greenfield-Rule.
