...
Once you’ve logged in to the virtual desktop, click the **Firefox Web Browser** icon.
...
Return to the Guacamole client, open the hidden Clipboard window by pressing _Ctrl+Alt+Shift_ (Windows) or _Control+Shift+Command_ (Mac), then paste the URL you copied earlier from Copilot.
...
After you press Enter on the URL in the browser, a warning message will appear—this is the `self-signed certificate warning`. Click **Advanced**, then select **Accept the Risk and Continue**.
...
The Fortinet welcome page will appear. Enter your credentials there.

```{important}
You can retrieve the credentials from the POD Portal—please always refer to your own personal POD. The images shown are examples and may refer to a different POD.
```{figure} images/lab3-newporta45699.png
---
align: center
---
Credentials
...
```{figure} images/lab3-newporta456.png
---
align: center
---
Fortinet Sign-In
